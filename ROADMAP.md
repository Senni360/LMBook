...
- Version 0.3.8 adds native Apple Silicon and Intel Mac packaging, Finder tool discovery and Mac window/menu behavior. Native CI and release verification are in progress; see [Mac setup](docs/macos.md).
